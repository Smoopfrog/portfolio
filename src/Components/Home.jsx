    ...
    <section className="home" id="home">
      {/* <div className="home-container"> */}
        ...
        <div className="home-info">
          ...
          <p>
            Hello, I'm Jeff Stinson. A full-stack developer, with a background
            in hospitality management, keen to dive into the world of web
            development.
          </p>
        ...
        {/* 
          <div className="home-links">
            ...
            <a
              href="mailto: jeffstinson@hotmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg className="social-icon" viewBox="0 0 512 512">
        ...
        <div className="home-picture">
          <img  className="home-picture" src={me} alt="The most handsome man in the world" />
        </div>
      {/* </div> */}
    </section>
  );
